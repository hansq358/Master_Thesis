...
SIM_INPUT <- expand_grid(n=c(20,50,100,200,500,1000,2000),
                         mu1=0.05,
                         mu2=0.05,
                         sigma1=c(0.2,0.3,0.4),
                         sigma2=c(0.2,0.3,0.4),
                         rho=c(-0.9,-0.5,0,0.5,0.9),
                         rep=1:100)
Lib_Size=as.data.frame(sample(500:10000,2000))
```
...
simulation <- function(l){
  tryCatch(
    ...
    data1$Lib_Size=Lib_Size[1:n,]
    data1$Log_Lib_Size=log(data1$Lib_Size)
    ...
    rho1=cor(x1_new/data1$Lib_Size,x2_new/data1$Lib_Size)
    ...
    error=function(e){
      ...
      data2$Lib_Size=Lib_Size[1:n,]
      data2$Log_Lib_Size=log(data2$Lib_Size)
      ...
      #3 two correlation methods
      rho1=cor(x1_new/data2$Lib_Size,x2_new/data2$Lib_Size)
...
write.csv(x = result,file = "result_sigma.csv")
```
