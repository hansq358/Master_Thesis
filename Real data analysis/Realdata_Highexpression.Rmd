...
##Select mean and standard deviations, you can change the mean and the standard deviations as you want, randomly select
...
sub=as.data.frame(data1[data1$mean>=1.5&data1$mean<=3&data1$sd>=1&data1$sd<=3,])
...
write.csv(result,file = "high.csv")
```
...
png(file="hist_high_log.png", res=300, width=2000, height=2000)
